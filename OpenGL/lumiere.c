 ...
 * lumiere.c
 *
 *	Expérimentations autour du modèle d'illumination d'OpenGL	
 */
...
void place_light (GLfloat x, GLfloat y, GLfloat z) 
{
	...
	//**********************************
	GLfloat light_ambient[] ={0.2,0.2,0.2,100.0};
	GLfloat light_diffuse[] ={1.0,1.0,1.0,100.0};
	GLfloat light_specular[]={1.0,1.0,1.0,100.0};
...
void display () 
{
	...
	//**********************************
	define_material (1.1, 1.1, 1.1, 5,5,5, 2,2, 2, 0.9);
	place_background ();
	...
	//**********************************		
	define_material (0.1745,0.01175,0.01175,0.61425,0.04136,0.04136,0.0727811,0.626959,0.626959,shininess);
	// RUBY
	...
	//**********************************
	define_material (0.0215,  0.1745,   0.0215,0.07568, 0.61424,  0.07568, 0.633,   0.727811, 0.633, 76.8);
	//EMERALD
...
/*
 *	Appelé à chaque changement de taille de la fenêtre
 *	(w,h) la nouvelle taille
 */
...
/*
 * Gestion des touches spéciales (flèches ...)
 */
...
int main (int argc, char **argv) 
{
	...
	glutCreateWindow ("Expérimentations autour de l'éclairage");
